...
def main():
    ...
    parser.add_argument("-m", "--max", type=int, default=100, help="The maximum number of tokens to generate for completions")
    ...
    if args.question:
        print("Sending query...")
        response = cli.handle_completion(args.question, n=args.number, t=args.temperature, m=args.max)
